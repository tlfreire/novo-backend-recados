...
const routes_1 = __importDefault(require("../../features/message/presentation/routes/routes"));
const routes_2 = __importDefault(require("../../features/user/presentation/routes/routes"));
class App {
    constructor() {
    ...
    routes() {
        ...
        const userRoutes = new routes_2.default().init();
        const messageRoutes = new routes_1.default().init();
        __classPrivateFieldGet(this, _App_express, "f").use(userRoutes, messageRoutes);
    }
    start(port) {
        __classPrivateFieldGet(this, _App_express, "f").listen(port, () => console.log(`Server is running on ${port}`));
    }
}
exports.default = App;
