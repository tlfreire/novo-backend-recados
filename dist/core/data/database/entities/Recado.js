...
var Recado = /** @class */ (function (_super) {
    ...
    function Recado(descricao, detalhe, userId) {
        var _this = _super.call(this) || this;
        _this.descricao = descricao;
        _this.detalhe = detalhe;
        _this.userId = userId;
        return _this;
    }
    __decorate([
    ...
    __decorate([
        typeorm_1.Column({ name: "detalhe" }),
        __metadata("design:type", String)
    ], Recado.prototype, "detalhe", void 0);
    __decorate([
        typeorm_1.Column({ name: "id_user" }),
        __metadata("design:type", Number)
    ], Recado.prototype, "userId", void 0);
    __decorate([
        typeorm_1.ManyToOne(function () { return User_1.User; }, function (user) { return user.recados; }),
        typeorm_1.JoinColumn({ name: "id_user", referencedColumnName: "id" }),
        __metadata("design:type", UserRoutes_1.default)
    ], Recado.prototype, "user", void 0);
    Recado = __decorate([
