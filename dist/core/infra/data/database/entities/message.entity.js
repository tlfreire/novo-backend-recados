...
__decorate([
    typeorm_1.Column(),
    __metadata("design:type", String)
], MessageEntity.prototype, "detail", void 0);
__decorate([
    typeorm_1.ManyToOne((_) => user_entity_1.UserEntity, (user) => user.messages),
...
], MessageEntity.prototype, "antesDeInserir", null);
MessageEntity = __decorate([
    typeorm_1.Entity({ name: "messages_" })
], MessageEntity);
