...
var UserController = /** @class */ (function () {
    ...
    UserController.prototype.store = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, email, senha, user, error_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, new User_1.User(email, senha).save()];
                    case 2:
                        user = _b.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, res
                                .status(200)
                                .json(result.affected > 0 ? "User excluido" : "Não removeu")];
                }
            });
        });
    };
    UserController.prototype.update = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var id, _a, email, senha, user, result;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        id = req.params.id;
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, User_1.User.update(id, {
                                email: email,
                                senha: senha,
                            })];
                    case 2:
